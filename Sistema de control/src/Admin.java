...
public class Admin extends javax.swing.JFrame {
    ...
    void cargagri1(String valor){
        ...
        String sql="SELECT*FROM entrada WHERE nombre LIKE '%"+valor+"%'";
     ...
     void cargagri11(String valor){
        ...
        String[]registro=new String[4];
        DefaultTableModel model = new DefaultTableModel(null,titulos);
        String sql="SELECT*FROM retiro WHERE nombre LIKE '%"+valor+"%'";
    ...
    private void initComponents() {
        ...
        jPanel1.add(dia, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 450, 150, 20));
    ...
    private void diaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_diaActionPerformed
        Admin_dia newframe = new Admin_dia();
        newframe.setVisible(true);
        this.dispose();
